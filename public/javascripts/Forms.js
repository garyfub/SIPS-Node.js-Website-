...
function addInjuryQuestions(){
    ...
    $(".form-group").append('<article id="apage_' + num + '" class="part2 Question' + num + '">' +
        ...
        '<input name="' + newName + '" value="1" type="radio" id="' + newID + '-1">'+
        'Foot/Toe'+
        '</label>'+
        '<label class="radio-inline" for="' + newID + '-2">'+
        '<input name="' + newName + '" value="2" type="radio" id="' + newID + '-2">'+
        'Ankle'+
        '</label>' +
        '<label class="radio-inline" for="' + newID + '-3">'+
        '<input name="' + newName + '" value="3" type="radio" id="' + newID + '-3">'+
        'Lower Leg'+
        '</label>'+
        '<label class="radio-inline" for="' + newID + '-4">'+
        '<input name="' + newName + '" value="4" type="radio" id="' + newID + '-4">'+
        'Knee'+
        '</label>' +
        '<label class="radio-inline" for="' + newID + '-5">'+
        '<input name="' + newName + '" value="5" type="radio" id="' + newID + '-5">'+
        'Thigh/Groin/Hip'+
        '</label>'+
        '<label class="radio-inline" for="' + newID + '-6">'+
        '<input name="' + newName + '" value="6" type="radio" id="' + newID + '-6">'+
        'Pelvis/Abdomen/Low Back'+
        '</label>' +
        '<label class="radio-inline" for="' + newID + '-7">'+
        '<input name="' + newName + '" value="7" type="radio" id="' + newID + '-7">'+
        'Ribs/Chest'+
        '</label>'+
        '<label class="radio-inline" for="' + newID + '-8">'+
        '<input name="' + newName + '" value="8" type="radio" id="' + newID + '-8">'+
        'Neck/Upper Back'+
        '</label>' +
        '<label class="radio-inline" for="' + newID + '-9">'+
        '<input name="' + newName + '" value="9" type="radio" id="' + newID + '-9">'+
        'Shoulder/Upper Arm'+
        '</label>'+
        '<label class="radio-inline" for="' + newID + '-10">'+
        '<input name="' + newName + '" value="10" type="radio" id="' + newID + '-10">'+
        'Elbow/Forearm'+
        '</label>' +
        '<label class="radio-inline" for="' + newID + '-11">'+
        '<input name="' + newName + '" value="11" type="radio" id="' + newID + '-11">'+
        'Wrist/Hand/Finger'+
        '</label>'+
    ...
    $(".form-group").append('<article id="apage_' + num + '" class="part2 Question' + num + '">' +
        ...
        '<input name="' + newName + '" value="1" type="radio" id="' + newID + '-1" onclick="checkvalue(this)">'+
        'Joint Strain'+
        '</label>'+
        '<label class="radio" for="' + newID + '-2">'+
        '<input name="' + newName + '" value="2" type="radio" id="' + newID + '-2" onclick="checkvalue(this)">'+
        'Muscle Strain'+
        '</label>' +
        '<label class="radio" for="' + newID + '-3">'+
        '<input name="' + newName + '" value="3" type="radio" id="' + newID + '-3" onclick="checkvalue(this)">'+
        'Fracture'+
        '</label>' +
        '</fieldset>' +
        '<br>'+
        ...
        '<input name="' + newName + '" value="4" type="radio" id="' + newID + '-4" onclick="checkvalue(this)">'+
        'Muscle/Tendon Disorder'+
        '</label>' +
        '<label class="radio" for="' + newID + '-5">'+
        '<input name="' + newName + '" value="5" type="radio" id="' + newID + '-5" onclick="checkvalue(this)">'+
        ...
        '<input name="' + newName + '" value="6" type="radio" id="' + newID + '-6" onclick="checkvalue(this)">'+
        'Custom'+
        '</label>' +
        '<br>' +
    ...
    $(".form-group").append('<article id="apage_' + num + '" class="part2 Question' + num + '">' +
        ...
        '<label class="radio-inline" for="' + newID + '-1">'+
        '<input name="' + newName + '" value="0" type="radio" id="' + newID + '-1">'+
        'No - Able to continue participating, despite reduced capabilities'+
        '</label>'+
        '<label class="radio-inline" for="' + newID + '-2">'+
        '<input name="' + newName + '" value="1" type="radio" id="' + newID + '-2">'+
